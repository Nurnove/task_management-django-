...
from users.views import SignUp, CustomLogin, SignOut, activate_user,AdminDashboard,AssignRole,CreateGroup,GroupList,ProfileView, ChangePassword , CustomPasswordResetView, CustomPasswordResetConfirmView, EditProfileView
